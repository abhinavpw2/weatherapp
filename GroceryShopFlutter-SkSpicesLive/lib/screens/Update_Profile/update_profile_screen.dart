  ...
  Widget _buildTopView() {
    return Column(
      ...
      children: [
        ...
        CustomerTypeFromLogin.toLowerCase() == "admin"?Container(
          margin: EdgeInsets.only(left: 10, right: 10),
          child: Row(children: [
            Container(
              child: Text("InActive",
                  ...
                  if (_offlineLogindetails.details[0].customerType !=
                          ...
                          _categoryScreenBloc
                              .add(CustomerRegistrationRequestCallEvent(
                                  ...
                                  CustomerRegistrationRequest(
                                      ...
                                      BlockCustomer: _isSwitched==false?"0":"1",
                    ...
                    showCommonDialogWithTwoOptions(
                      ...
                      onTapOfPositiveButton: () {
                        ...
                        String LoginUserID =
                            _userNameController.text.toString().trim();
                        String BlockCustomer = _isSwitched==false?"0":"1";
                        String ProfileImage = "";
                        String Password = _passwordController.text.toString();
                        String CompanyId = CompanyID;
                        String CustType = _customerTypeController.text
