...
/*    _firstScreenBloc.add(MasterBaseURLCallEvent(CompanyDetailsApiRequest(
        serialKey: "BBBB-BBBB-BBBB-BBBB")));*/
    _firstScreenBloc
      .add(MasterBaseURLCallEvent(
          CompanyDetailsApiRequest(serialKey: "SK09-SPCS-USCF-9T3K")));
  }
    ...
    return BlocProvider(
      ...
      child: BlocConsumer<FirstScreenBloc, FirstScreenStates>(
        ...
        buildWhen: (oldState, currentState) {
          if (currentState is MasterBaseURLResponseState || currentState is ComapnyDetailsEventResponseState) {
            return true;
          }
          return false;
        },
