...
class ApiClient {
  ...
  //static const BASE_URL = 'http://122.169.111.101:106/'; //UK Client Local BaseURL


 // static const BASE_URL = 'http://208.109.14.134:89/'; //UK Client Local BaseURL
  static const END_POINT_MASTER_BASE_URL = 'BaseURL/SerialKey';

  //static const BASE_URL = 'http://68.178.170.35:89/';
  ...
  Future<dynamic> apiCallPost(
    ...
    var baseUrl = "";
    baseUrl = SharedPrefHelper.instance.getBaseURL();
  ...
  Future<dynamic> apiCallPutMultipart(
      ...
      {File imageFileToUpload, String baseUrl = ""}) async {
    var responseJson;
    var baseUrl = "";
    baseUrl = SharedPrefHelper.instance.getBaseURL();
    print("$baseUrl$url\n$requestJsonMap");
  ...
  Future<dynamic> apiCallPut(String url, Map<String, dynamic> requestJsonMap,
      {String baseUrl = "", bool showSuccessDialog = false}) async {
    var responseJson;
    var baseUrl = "";
    baseUrl = SharedPrefHelper.instance.getBaseURL();
    Map<String, String> headers = {
      ...
      case 200:
        ...
        if (responseJson["Status"] == 3) {
          ...
          if(message=="USER IS INACTIVE")
            {
              await showCommonErrorMessageDialog(Globals.context, "",
                  positiveButtonTitle: "OK");
