...
Future showCommonErrorMessageDialog(
    BuildContext context,
    String message, {
      String positiveButtonTitle = "OK",
      GestureTapCallback onTapOfPositiveButton,
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Material(
                          ...
                          child: Text(
                            "You Are Not Registered Authorised Person Kindly Contact To Admin",
                            maxLines: 15,
                            textAlign: TextAlign.center,
                            style: TextStyle(fontSize: 15,fontWeight: FontWeight.bold,color: colorPrimary),
                          ),
                        ),
                        SizedBox(height: 10,),
                        Container(
                            ...
                            children: [
                              Material(
                                child: SelectableText(
                                  "Address : 39 Wyvern Avenue,Leicester,LE4 7HJ",
                                  textAlign: TextAlign.center,
